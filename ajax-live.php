...
$con = mysqli_connect("localhost", "root", "", "stu_info") or die("failed");
$sql1 = "SELECT * FROM student WHERE NAME LIKE '%he%'";
...
$sql = "select * from student WHERE NAME LIKE '%$search%' limit {$offset},{$page_limit} ";
$result = mysqli_query($con, $sql) or die("not database");

$output = "";

$output .= '   <div class="row mt-2"> <table class="table mt-2  table-striped table-bordered">
                <thead>
                    <tr class="table-dark">
                        <th scope="col">No</th>
